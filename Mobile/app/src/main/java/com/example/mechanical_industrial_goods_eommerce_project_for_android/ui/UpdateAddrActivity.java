...
public class UpdateAddrActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameEdit= (EditText) findViewById(R.id.update_name);
        numEdit= (EditText) findViewById(R.id.update_num);
        proEdit= (EditText) findViewById(R.id.update_pro);
        cityEdit= (EditText) findViewById(R.id.update_city);
        qvEdit= (EditText) findViewById(R.id.update_qv);
        addressEdit= (EditText) findViewById(R.id.update_address);
        youbianEdit= (EditText) findViewById(R.id.update_youbian);
        findViewById(R.id.update_addr_button).setOnClickListener(this);
    }
    @Override
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.update_addr_button:

                //跳转到订单列表activity
                Intent intent = new Intent(UpdateAddrActivity.this, AddressListActivity.class);
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        Toast.makeText(UpdateAddrActivity.this,"网络问题，请稍后重试！",Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(UpdateAddrActivity.this,AddressListActivity.class);
                        startActivity(intent);
                    }
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if(result.getStatus()== ResponseCode.SUCCESS.getCode()){
                            Toast.makeText(UpdateAddrActivity.this,"添加成功！",Toast.LENGTH_SHORT).show();
                            UpdateAddrActivity.this.finish();
                        }else{
                            Toast.makeText(UpdateAddrActivity.this,"添加失败！",Toast.LENGTH_SHORT).show();
                            Toast.makeText(UpdateAddrActivity.this,result.getMsg(),Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
